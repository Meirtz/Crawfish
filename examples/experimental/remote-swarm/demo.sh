...
cp "${REPO_ROOT}/examples/experimental/remote-swarm/Crawfish.toml" "${WORKDIR}/Crawfish.toml"
...
python3 - "${WORKDIR}/agents/task_planner.toml" <<'PY'
...
echo "== Experimental swarm status =="
